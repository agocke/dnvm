    ...
    public static Manifest Convert(this ManifestV10 manifestV10)
    {
        return new Manifest
        {
            ...
            InstalledSdks = manifestV10.InstalledSdks.SelectAsArray(sdk => new InstalledSdk
            {
                ...
                RollForward = sdk.RollForward.Convert(),
...
public static class RollForwardOptionsExt
{
    public static InstalledSdkV10.RollForwardOptions Convert(this InstalledSdk.RollForwardOptions rollForward)
    {
        return rollForward switch
        {
            InstalledSdk.RollForwardOptions.Disable => InstalledSdkV10.RollForwardOptions.Disable,
            InstalledSdk.RollForwardOptions.Patch => InstalledSdkV10.RollForwardOptions.Patch,
            InstalledSdk.RollForwardOptions.Minor => InstalledSdkV10.RollForwardOptions.Minor,
            InstalledSdk.RollForwardOptions.Major => InstalledSdkV10.RollForwardOptions.Major,
        };
    }
}
...
public static class RollForwardOptionsConvert
{
    public static InstalledSdk.RollForwardOptions Convert(this InstalledSdkV10.RollForwardOptions rollForward)
    {
        return rollForward switch
        {
            InstalledSdkV10.RollForwardOptions.Disable => InstalledSdk.RollForwardOptions.Disable,
            InstalledSdkV10.RollForwardOptions.Patch => InstalledSdk.RollForwardOptions.Patch,
            InstalledSdkV10.RollForwardOptions.Minor => InstalledSdk.RollForwardOptions.Minor,
            InstalledSdkV10.RollForwardOptions.Major => InstalledSdk.RollForwardOptions.Major,
        };
    }
}